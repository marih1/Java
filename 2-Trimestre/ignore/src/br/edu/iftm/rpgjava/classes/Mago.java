...
public class Mago {
    ...
    public Mago(String nome, int forca, int destreza, int agilidade, int inteligencia, int carisma, int resistencia,
                int vida, int estamina, int sorte, int mana) {
        this.nome = nome;
        this.forca = forca;
    ...
    public int atacar(int valorDado, int defesaInimigo) {
        int valorAtaque = (this.mana + this.inteligencia) / 3;
        ...
        if(valorDado < 2){
            ...
            if (arma != null) {
                ...
                valorAtaque = arma.calculaAtaque(valorAtaque) + valorDado;
    ...
    public void defender(int valorDoAtaque) {
        ...
        if(valorDoAtaque <= defesaTotal){
            ...
            this.armadura.diminuiDurabilidade(danoCausado);
